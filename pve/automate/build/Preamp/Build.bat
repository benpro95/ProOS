...
SET SKETCH_PATH=Z:\ProOS\pve\automate\build
SET SKETCH_NAME=Preamp
...
"%ARDUINO_CLI%" -v upload -p COM6 --fqbn arduino:avr:uno --input-dir "%LocalAppData%\Arduino15\build"
pause
exit