...
function DisplayAuthConfig($username, $password){
  ...
  if (isset($_POST['ResetAdminPassword'])) {
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-primary">
        <div class="panel-heading"><i class="fa fa-lock fa-fw"></i>Configure Authorization</div>
        <div class="panel-body">
          ...
          <form role="form" action="?page=auth_conf" method="POST">
            ...
            <input type="submit" class="btn btn-outline btn-primary" name="ResetAdminPassword" value="Reset settings" />
          </form>
        </div><!-- /.panel-body -->
      </div><!-- /.panel-default -->
    </div><!-- /.col-lg-12 -->
